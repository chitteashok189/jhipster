...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, org.jhipster.blog.domain.Farm.class.getName() + ".protectedFarms");
            createCache(cm, org.jhipster.blog.domain.ProtectedFarm.class.getName());
            createCache(cm, org.jhipster.blog.domain.ProtectedFarm.class.getName() + ".zones");
