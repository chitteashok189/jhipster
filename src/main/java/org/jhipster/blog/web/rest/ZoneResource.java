        ...
        Optional<Zone> result = zoneRepository
            ...
            .map(existingZone -> {
                if (zone.getZoneID() != null) {
                    existingZone.setZoneID(zone.getZoneID());
                }
                if (zone.getZoneType() != null) {
                    existingZone.setZoneType(zone.getZoneType());
                }
                if (zone.getManufacturer() != null) {
                    existingZone.setManufacturer(zone.getManufacturer());
                }
                if (zone.getProtectedFID() != null) {
                    existingZone.setProtectedFID(zone.getProtectedFID());
                }
