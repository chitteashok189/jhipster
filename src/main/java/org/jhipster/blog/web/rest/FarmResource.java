        ...
        Optional<Farm> result = farmRepository
            ...
            .map(existingFarm -> {
                if (farm.getFarmID() != null) {
                    existingFarm.setFarmID(farm.getFarmID());
                }
                if (farm.getPformID() != null) {
                    existingFarm.setPformID(farm.getPformID());
                }
                ...
                if (farm.getFarmSubType() != null) {
                    existingFarm.setFarmSubType(farm.getFarmSubType());
                }
