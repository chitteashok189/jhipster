...
describe('Zone e2e test', () => {
  ...
  describe('new Zone page', () => {
    ...
    it('should create an instance of Zone', () => {
      cy.get(`[data-cy="zoneID"]`)
        .type('6b707237-7c7d-48d7-83e8-a564c7ddfd2d')
        .invoke('val')
        .should('match', new RegExp('6b707237-7c7d-48d7-83e8-a564c7ddfd2d'));

      cy.get(`[data-cy="zoneType"]`).select('Bench');

      cy.get(`[data-cy="manufacturer"]`).type('24/365').should('have.value', '24/365');

      cy.get(`[data-cy="protectedFID"]`)
        .type('221373d8-69ab-49bf-bd66-e8e4f8c8e705')
        .invoke('val')
        .should('match', new RegExp('221373d8-69ab-49bf-bd66-e8e4f8c8e705'));
